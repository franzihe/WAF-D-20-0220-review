...
\abstract{
	...
	Thus, simulations overestimate the amount of accumulated surface precipitation while underestimating snowfall in the vertical. These results highlight the need for further studies to constrain better the interplay between snow evolution in the vertical and snowfall at the surface in numerical weather prediction models.
}
...
\section{Results}\label{sec:res}
	...
	\subsection{Validation of the vertical distribution of snowfall}\label{sec:res:swc}
		...
		Thus, the maximum mean SWC is assumed to correspond to the mean cloud base height. When comparing to the modeled SWC, both the CTRL and ICE-T simulations also capture a decrease in SWC at $\sim$600\,m above the surface (see Fig. \ref{fig:vert_swc}a), indicating that they correctly account for the vertical evolution of hydrometeors as they fall to the surface.
