...
%DIF ADD revision_V2.tex   Fri Jun 18 16:12:10 2021
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%DIFDELCMD <     %%%
\DIFdel{A Micro Rain Radar and a Multi-Angle Snowflake Camera provide microphysical information exploited in an optimal estimation retrieval (OESR). The validation of snowfall forecasts focused on winter 2016-2017 when High-Latitude Measurement of Snowfall deployed these instruments at the Haukeliseter test sitein Norway. }\DIFdelend \DIFaddbegin \DIFadd{. The presented verification technique uses a combined DFAR and MRR retrieval approach to obtain vertical profiles of snow water and surface snowfall accumulation at the Haukelister test site, Norway. Surface and vertical snow observations are used to validate against model simulations from the Norwegian Meteorological Institute's operational forecast system and two simulations with adjusted cloud microphysics.  This method can not only the surface snowfall accumulation but also the precipitation in the vertical be validated.  }\DIFaddend \\ 
	...
	\DIFadd{The results show that we would reach false conclusions only using surface accumulation or vertical snow water content profiles}\DIFaddend . These results highlight the need for \DIFdelbegin \DIFdel{further studies to constrain better the interplay between the evolution of snow in the vertical and snowfall at the surface in numerical weather prediction models}\DIFdelend \DIFaddbegin \DIFadd{a combination of ground-based in situ and vertically-profiling remote sensing instruments}\DIFaddend .
}
